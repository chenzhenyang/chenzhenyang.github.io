...
![The software delivery feedback loops: An upper "why" loop connected to a lower "how" loop. The why loop iterates over an idea and working software. The how loop iterates over interim artefacts like specs, code, and tests.](humans-agents-image1.png)
...
![Multiple levels of "how" loops supporting the "why" loop. An outer loop iterates on a feature. A middle loop iterates on stories. An inner loop iterates on code.](humans-agents-image2.png)
...
![Humans in the loop: A single "why+how" loop with a human at the top and a robot at the bottom. The loop iterates over idea, interim artefacts like code and tests, and the working software.](humans-agents-image4.png)
...
![Humans on the loop: An upper "why" loop connected to a lower "how" loop by a human. The why loop iterates over an idea and working software.A robot sits at the bottom of the lower "how" loop, which iterates over interim artefacts like specs and code.](humans-agents-image5.png)
...
![Flywheel: An upper "why" loop connected to a lower "how" loop by a human and a robot. The why loop iterates over an idea and working software. The how loop iterates over interim artefacts like specs.](humans-agents-image6.png)
